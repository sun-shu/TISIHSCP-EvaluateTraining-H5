...
export async function receiveCommonBraceletsUsingPost(
  body: clientApiInterface.ComMsgInfoFromLyDto,
  options?: { [key: string]: any },
) {
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouString>(
    `/hcsp-gateway/clientApi/v1/third/common/bracelets`,
    {
      method: 'POST',
      headers: {
...
export async function receiveCommonMsgUsingPost(
  ...
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouString>(
    `/hcsp-gateway/clientApi/v1/third/common/msg`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function elderTrainUsingGet(
  ...
  params: clientApiInterface.elderTrainUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<Record<string, any>>(`/hcsp-gateway/clientApi/v1/third/h5/train`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function timeCommonMsgUsingPost(
  ...
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouString>(
    `/hcsp-gateway/clientApi/v1/third/time/msg`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function trainElderEveryWeekNumUsingGet(options?: { [key: string]: any }) {
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouTrainElderEveryWeekNumDto>(
    `/hcsp-gateway/clientApi/v1/third/train/elder`,
    {
      method: 'GET',
      ...(options || {}),
    },
