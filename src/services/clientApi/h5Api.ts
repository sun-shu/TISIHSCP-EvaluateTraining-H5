...
export async function getHcspGatewayBaseApiV1CognitiveDisordersH5AffectionTraining(
  ...
  params: clientApiInterface.getHcspGatewayBaseApiV1CognitiveDisordersH5AffectionTrainingParams,
  ...
  }>(`/hcsp-gateway/clientApi/v1/hcsp-gateway/baseApi/v1/cognitiveDisordersH5/affectionTraining`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getHcspGatewayBaseApiV1CognitiveDisordersH5TrainingPlan(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.getHcspGatewayBaseApiV1CognitiveDisordersH5TrainingPlanParams,
  options?: { [key: string]: any },
) {
  return request<{
    data: {
  ...
  }>(`/hcsp-gateway/clientApi/v1/hcsp-gateway/baseApi/v1/cognitiveDisordersH5/trainingPlan`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getHcspGatewayBaseApiV1CognitiveDisordersH5TrainingPlanDay(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.getHcspGatewayBaseApiV1CognitiveDisordersH5TrainingPlanDayParams,
  options?: { [key: string]: any },
) {
  return request<{
    data: { amDataList: { className: string }[]; pmData: { className: string }[] };
  }>(`/hcsp-gateway/clientApi/v1/hcsp-gateway/baseApi/v1/cognitiveDisordersH5/trainingPlanDay`, {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getHcspGatewayBaseApiV1CognitiveDisordersH5TrainingReport(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.getHcspGatewayBaseApiV1CognitiveDisordersH5TrainingReportParams,
  options?: { [key: string]: any },
) {
  return request<{
    data: {
  ...
  }>(`/hcsp-gateway/clientApi/v1/hcsp-gateway/baseApi/v1/cognitiveDisordersH5/trainingReport`, {
    method: 'GET',
    params: {
      ...params,
    },
