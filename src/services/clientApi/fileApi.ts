...
export async function deleteFileUsingDelete(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.deleteFileUsingDELETEParams,
  options?: { [key: string]: any },
) {
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGou>(
    `/hcsp-gateway/clientApi/v1/files/dleFile`,
    {
      method: 'DELETE',
      params: {
        ...params,
...
export async function downLoadUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.downLoadUsingGETParams,
  options?: { [key: string]: any },
) {
  const { fileId: param0, ...queryParams } = params;
  return request<Record<string, any>>(`/hcsp-gateway/clientApi/v1/files/download/${param0}`, {
    method: 'GET',
    params: {
      ...queryParams,
    },
...
export async function uploadPrivateFileUsingPost(
  ...
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouUploadFileInfoVo>(
    `/hcsp-gateway/clientApi/v1/files/private`,
    {
      method: 'POST',
      data: formData,
      requestType: 'form',
...
export async function uploadPublicFileUsingPost(
  ...
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouUploadFileInfoVo>(
    `/hcsp-gateway/clientApi/v1/files/public`,
    {
      method: 'POST',
      data: formData,
      requestType: 'form',
...
export async function uploadPictureUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.uploadPictureUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouString>(
    `/hcsp-gateway/clientApi/v1/files/public/uploadPicture`,
    {
      method: 'POST',
      params: {
        ...params,
...
export async function uploadVideoUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: clientApiInterface.uploadVideoUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<clientApiInterface.FanHuiLeiXingJiChuJieGouString>(
    `/hcsp-gateway/clientApi/v1/files/public/uploadVideo`,
    {
      method: 'POST',
      params: {
        ...params,
